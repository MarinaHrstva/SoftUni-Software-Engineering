import {UserActions, UserListConstants} from '../UserListConstants'
...
export const UserItem = ({
  ...
  onActionClick
    ...
    const blankUrl='https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTrAnrKd_ZSdXgEub3J5dsI4KNUgM4iuIbWV2cIL_30ZwtWIPzLMBwouzbELssEreM_z9I&usqp=CAU';

    return (

        <tr>
            <td>
                <img src={user.imageUrl || blankUrl}
